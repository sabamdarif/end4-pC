...
Variants {
    ...
    PanelWindow {
        ...
        Item {
            ...
            // Desktop widgets are compiled and built off the UI thread; the wallpaper
            // above does not wait for them.
            Loader {
                anchors.fill: parent
                asynchronous: true
                Component.onCompleted: setSource("BackgroundWidgets.qml", {
                    "panel": bgRoot,
                })
            }
