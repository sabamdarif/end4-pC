// From https://github.com/pctrade/end4-pC/pull/94 and /pull/110 by @Blapples
...
// map/unmap animation the compositor (niri) already plays for every other
...
Scope {
    ...
    readonly property real popupRounding: Appearance.rounding.screenRounding - Appearance.sizes.windowGapsOut + 1
