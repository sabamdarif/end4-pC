...
Singleton {
    ...
    sizes: QtObject {
        ...
        property real barHeight: Config.options.bar.cornerStyle === 1 ? 
            (baseBarHeight + root.sizes.windowGapsOut * 2) : baseBarHeight
        ...
        property real verticalBarWidth: Config.options.bar.cornerStyle === 1 ? 
            (baseVerticalBarWidth + root.sizes.windowGapsOut * 2) : baseVerticalBarWidth
