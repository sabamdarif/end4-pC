...
Singleton {
    ...
    property string videoWallpaperThumbnails: FileUtils.trimFileProtocol(`${Directories.state}/user/generated/wallpaper/mpvpaper_thumbnails`)
    property string cliphistDecode: FileUtils.trimFileProtocol(`/tmp/quickshell/media/cliphist`)
    property string screenshots: FileUtils.trimFileProtocol(`${Directories.pictures}/Screenshots`)
    property string screenshotTemp: "/tmp/quickshell/media/screenshot"
    property string wallpaperSwitchScriptPath: FileUtils.trimFileProtocol(`${Directories.scriptPath}/colors/switchwall.sh`)
    property string userActions: FileUtils.trimFileProtocol(`${Directories.shellConfig}/actions`)
    property string userEmojis: FileUtils.trimFileProtocol(`${Directories.shellConfig}/emojis.txt`)
    property string systemSounds: FileUtils.trimFileProtocol(`${Directories.shellConfig}/sounds`)
    ...
    Component.onCompleted: {
        ...
        Quickshell.execDetached(["mkdir", "-p", `${systemSounds}`])
